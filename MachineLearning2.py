...
def train_test_split(X, y):
    ...
    y_train=y[0:60000].reshape(-1,1)
    y_test=y[60000:70000].reshape(-1,1)    
...
def discrimination_by_regression(X_train, Y_train,
    ...
    while iteration_count>0:
        ...
        objective_values= np.append(objective_values,np.sum((Y_train-Y_predicted)**2)*0.5)
...
def calculate_confusion_matrix(y_truth, y_predicted):
    # your implementation starts below 
    confusion_matrix = pd.crosstab(y_predicted.T,y_truth.T).to_numpy()    
    # your implementation ends above
